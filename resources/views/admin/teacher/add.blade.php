                ...
                <div class="card-body">
                    ...
                    <form action="{{route("teacher.new")}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" name="phone_no" id="horizontal-password-input1">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <textarea type="" class="form-control" name="address" id="horizontal-password-input2"></textarea>
                            </div>
                        </div>
