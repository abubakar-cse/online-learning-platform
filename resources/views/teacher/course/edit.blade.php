                ...
                <div class="card-body">
                    ...
                    <form action="{{route("course.update", ['id' => $course->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <textarea type="" class="form-control" name="short_description" id="horizontal-password-input2">{{$course->short_description}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <textarea type="" class="form-control summernote" name="long_description" id="horizontal-password-input4">{{$course->long_description}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img src="{{asset($course->image)}}" alt="" height="100" width="150" class="py-2">
                            </div>
                        </div>
